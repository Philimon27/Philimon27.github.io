...
function findAllValuesWithGivenKeys(json, givenKey) {
    if (Array.isArray(json) || typeof json != 'object')
        return [];
    let matchingKeys = [];
    for (let key in json) {
        ...
        matchingKeys = matchingKeys.concat(findAllValuesWithGivenKeys(value, givenKey));
    }
    return matchingKeys;
}
console.log(findAllValuesWithGivenKeys(json,"GlossSeeAlso"))
